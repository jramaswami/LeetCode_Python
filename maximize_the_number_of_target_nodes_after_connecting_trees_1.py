    ...
    def maxTargetNodes(self, edges1: List[List[int]], edges2: List[List[int]], k: int) -> List[int]:
        ...
        def bfs(root, graph, max_dist):
            ...
            while queue:
                u, d = queue.popleft()
                for v in graph[u]:
                    if v not in visited and d + 1 <= max_dist:
                        visited.add(v)
                        queue.append((v, d + 1))
            return len(visited)
...
def test_4():
    ...
    k = 21
    expected = [81,81,81,81,81,81,81,81,81,81,81,81,81,81,81,81,81,81,81,81,81,81,81,81,81,81,81,81,81,81,81,81,81,81,81,81,81,81,81,81]
    assert Solution().maxTargetNodes(edges1, edges2, k) == expected